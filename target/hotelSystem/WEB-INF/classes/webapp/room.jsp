    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <c:if test="${USER==null}">
                    <li class="active"><a href="${Pages.LOGIN_JSP.toString()}">登录</a></li>
                </c:if>
...
<c:if test="${param.view=='room'}">
    ...
    <div class="maxPage-summary" style="height: 500px;width:1920px">
        <div class="info-panel" style="padding-top: 30px">
            ...
            <div class="photo-name">
                <img class="main_info" src="${pageContext.request.contextPath}/file/photo/${data.rooms[0].photo}" width="300" height="300">
    ...
    <div class="color-input-field">
        <form action="${pageContext.request.contextPath}/${Pages.ORDER_JSP.toString()}?view=add&roomId=${data.rooms[0].id}&userId=${data.users[0].id}&user=${USER}&room=${data.rooms[0].number}&hotel=1234&price=${data.rooms[0].price}"
              method="post">
