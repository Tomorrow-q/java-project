...
<head>
    <title>Xhotel</title>
    <meta charset="utf-8">
    <meta content="width=1920,initial-scale=1.0,maximum-scale=1.0,user-scalabl=yes"
...
<c:if test="${data==null}">
    ...
    <div class="well well-lg" style="height:fit-content;width: 80%;margin: 50px;max-width: 800px;padding: 10px;margin-top: 100px">
        ...
        <form action="${pageContext.request.contextPath}/remark?method=${Methods.ADD_DO}" method="post" >
        <textarea name="remark" class="form-control" autofocus="autofocus" cols="100"
            ...
            <input type="submit"  value="留言" class="form-control" style="width: 150px">
        </form>
    </div>
    <c:if test="${data.remarks.size()>0}">
        <c:forEach var="i" begin="0" end="${data.remarks.size()-1}">
            <div class="well well-lg" style="height:fit-content;width: 80%;margin: 50px;max-width: 800px;padding: 10px">
