...
<nav class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/${Pages.INDEX_JSP.toString()}">西西里</a>
        </div>
    ...
    <div class="maxPage-summary" style="height: 500px;width:1920px">
        <div class="info-panel">
            ...
            <div class="photo-name">
                <img class="main_info" src="${pageContext.request.contextPath}/file/photo/${data.rooms[i].photo}" width="300" height="300">
            ...
            <form class="input-info"
                ...
                <form class="input-info"
                      ...
                      method="post" enctype="multipart/form-data"></c:if>
                        <%-- 主图和名称--%>
                    <div class="photo-name">
                        <img class="main_info" src="${pageContext.request.contextPath}/file/photo/${data.rooms[i].photo}" width="300" height="300" alt="酒店图片">
                        <h3>${data.rooms[0].name}</h3>
