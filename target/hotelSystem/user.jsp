                ...
                <c:if test="${USER!=null&&ADMIN==null}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                                ...
                                <li><a href="/hotelSystem/user?method=${Methods.LOGOUT_DO.toString()}">退出登录</a></li>
<%--                            <li><a href="${pageContext.request.contextPath}/user?method=${Methods.LOGOUT_DO.toString()}">退出</a></li>--%>
                        </ul>
<%--${pageContext.request.contextPath}--%>
                    </li>
                </c:if>
                <c:if test="${ADMIN!=null}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="${Pages.USER_JSP.toString()}?view=update&update=pwd&name=${USER}">修改登录密码</a>
                            </li>

                            <li><a href="${pageContext.request.contextPath}/user?method=${Methods.LOGOUT_DO.toString()}">退出登陆</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
<%--                            <li><a href="${pageContext.request.contextPath}/hotel.html">查看酒店信息</a></li>--%>
    ...
    <div class="maxPage-summary" style="height: 500px;width:1920px">
        <div class="info-panel" style="margin-top: 30px">
            ...
            <div class="photo-name">
                <img class="main_info" src="${pageContext.request.contextPath}/file/photo/${data.users[0].photo}" width="300" height="300">
        ...
        <div class="maxPage-summary" style="height: 500px;width:1920px">
            <div class="info-panel">
                ...
                <form class="input-info"
                      ...
                      method="post" enctype="multipart/form-data">
                    <div class="photo-name">
                        <img class="main_info" src="/file/photo/${data.users[0].photo}" width="300" height="300" alt="用户图片">
                        <h3>${data.users[0].name}</h3>
<%--                        <h3>${data.users[0].}</h3>--%>
                        <input type="file"  class="file" name="photo">
                    </div>
